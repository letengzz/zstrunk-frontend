...
const categoryTree: TreeNode[] = [
  ...
  },
  {
    ...
    label: 'Tanker Trucks',
    children: [
      { id: 'tanker-carbon', label: 'Carbon Steel Tanker' },
      { id: 'tanker-oil', label: 'Oil Tanker Trailer' },
      { id: 'tanker-fuel', label: 'Fuel Tanker Truck' },
      { id: 'tanker-water', label: 'Water Tanker Truck' },
      { id: 'tanker-chemical', label: 'Chemical Tanker Truck' }
    ]
  },
  {
    id: 'excavator',
...
const filteredProducts = computed(() => {
  ...
  if (currentCategory.value !== 'all') {
    if (currentCategory.value.startsWith('tanker')) {
      result = result.filter(product => product.category === 'tanker')
    } else if (currentCategory.value.startsWith('excavator')) {
